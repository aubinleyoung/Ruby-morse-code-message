...
**[Ruby-morse-code-message]** is project do decode a morse code  message using Ruby.
...
2. clone with this command `git clone https://github.com/aubinleyoung/Ruby-morse-code-message.git`
3. cd Ruby-morse-code-message
...
Feel free to check the [issues page](https://github.com/aubinleyoung/Ruby-morse-code-message/issues).
